...
# Web Dev Journey– Day 29 

Namaste React Journey (Episodes 01-03)
...
# Overall, from Episodes 04-06, I learned:
How to build React apps with core concepts.
Props vs State and their roles in data management and reactivity.
Function mapping to render dynamic lists.
useState Hook to manage state in functional components efficiently.
Importance of file structuring and import/export for scalable projects.
useEffect Hook for handling side effects in components.
How to implement conditional rendering for dynamic UIs.
Fetching APIs in React to integrate real data into applications.
Practice multiple small projects using props, state, useState, and useEffect, integrate APIs, and deepen my understanding of hooks before advancing to Redux and advanced React concepts.
...
The concept of Higher-Order Components for reusing component logic.
Difference between Controlled and Uncontrolled components in forms.
Using React DevTools to debug and optimize React applications effectively.
Implementing Redux Toolkit for efficient state management.
Connecting Redux with React using React-Redux, and understanding actions and reducers to manage application state seamlessly.
...
# Web Dev Journey– Day 33 {start Building Youtbe project}
...
Using Tailwind CSS utility classes for building responsive and clean UIs quickly.
How to generate a YouTube API key and make secure API requests.
The structure of YouTube Data API endpoints and response data.
Planning dynamic UI rendering by mapping over fetched API data.
